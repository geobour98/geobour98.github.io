...
| -- | -- | -- |
| [:link:linux/x64/exec](#exec) | Execute an arbitrary command or just a /bin/sh shell | 21 |
| [:link:linux/x64/shell_bind_tcp](#bind) | Listen for a connection and spawn a command shell | 86 |
| [:link:linux/x64/shell_reverse_tcp](#reverse) | Connect back to attacker and spawn a command shell | 74 |  
...
**1{{< rawhtml >}}<sup>st</sup>{{< /rawhtml >}} syscall**
...
**2{{< rawhtml >}}<sup>nd</sup>{{< /rawhtml >}} syscall**
...
**3{{< rawhtml >}}<sup>rd</sup>{{< /rawhtml >}} syscall**
...
**4{{< rawhtml >}}<sup>th</sup>{{< /rawhtml >}} syscall**
...
**5{{< rawhtml >}}<sup>th</sup>{{< /rawhtml >}} syscall**
...
**6{{< rawhtml >}}<sup>th</sup>{{< /rawhtml >}} syscall**
