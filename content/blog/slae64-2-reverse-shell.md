...
| Part | Description | 
| -- | -- |
| [:link: TCP Reverse Shell](#tcp-reverse-shell) | TCP Reverse Shell with passcode |
| [:link: Reverse Shellcode](#reverse-shellcode) | Removing `0x00` from the Reverse Shellcode of the course |
