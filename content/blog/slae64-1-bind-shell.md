...
| Part | Description | 
| -- | -- |
| [:link: TCP Bind Shell](#tcp-bind-shell) | TCP Bind Shell with passcode |
| [:link: Bind Shellcode](#bind-shellcode) | Removing `0x00` from the Bind Shellcode of the course |
